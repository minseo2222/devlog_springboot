...
public class GlobalExceptionHandler {
    @ExceptionHandler(com.com.cnu.devlog_springboot.exception.DevlogException.class)
    public ResponseEntity<ErrorResponse> handleDevlogException(
            HttpServletRequest request, com.com.cnu.devlog_springboot.exception.DevlogException e
    ) {
